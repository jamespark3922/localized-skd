...
from lavis.datasets.datasets.image_text_web_datasets import ImageTextExtractedDataset
...
@registry.register_builder("laion_sample_extracted")
class LaionSampleBuilder(BaseDatasetBuilder):
    train_dataset_cls = ImageTextExtractedDataset
    eval_dataset_cls = ImageTextExtractedDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/laion/defaults_sample_extracted.yaml"}
